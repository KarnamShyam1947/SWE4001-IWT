<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(password_verify($pass, $_SESSION['username']['password'])) {
            if($pass1 == $pass2) {
    ...
    <div class="container d-flex align-items-center justify-content-center vh-100">
            <div class="card w-50 px-5 py-4">
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            <input type="password" name="pass" class="form-control" placeholder="Enter old password">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            <input type="password" name="pass2" class="form-control" placeholder="Renter new password">
                        </div>
                    </div>
